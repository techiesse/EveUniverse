...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TrackingListInstance',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('orderCount', models.IntegerField()),
                ('template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.TrackingList')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trackingList', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.TrackingListInstance')),
            ],
        ),
        migrations.CreateModel(
            name='TrackedItem',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EveAssets.Item')),
                ('trackingListTemplate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='main.TrackingList')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unitInstalationCost', models.DecimalField(blank=True, decimal_places=2, max_digits=30, null=True)),
